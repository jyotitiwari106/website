...
const HeroSection = () => {
  ...
  return (
    <div className="relative">
      {/* Hero Section */}
      <section className="relative h-screen md:h-[150vh] w-full overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col justify-center px-4 md:px-[10%] text-white h-full">
          ...
          <motion.div
            ...
            className="pt-8"
          >
            <button className="btn-12 w-full md:w-[20%] h-20 text-xl md:text-2xl hover:scale-105 transition-transform duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 justify-center">
            {services.map((service, index) => (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className="p-6 rounded-lg bg-white shadow-lg hover:shadow-2xl transition-all duration-300 backdrop-blur-md bg-opacity-95"
              >
                <motion.div
                ...
                <h3 className="text-xl md:text-2xl p-4 font-bold mb-3 text-black">
                  {service.title}
                </h3>
                <p className="mb-4 text-gray-600 text-sm md:text-base w-full md:w-[80%] p-3">
                  {service.description}
                </p>
                <Link
                  to="/services"
